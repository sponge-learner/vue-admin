		...
		<el-card class="box-card">
			...
			<el-form ref="form" :model="form" label-width="100px" :rules="rules">
				...
				<el-form-item label="商品轮播图" prop="slider">
					<!-- <el-upload class="upload-demo"  action="/api/upload/slider" :on-preview="handlePreview"
					 :on-remove="handleRemove" :file-list="fileList" list-type="picture-card">
						<el-button size="small" type="primary">点击上传</el-button>
						<div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
					</el-upload> -->
					<el-upload action="/api/upload/slider" :file-list="photo" list-type="picture-card" :on-error="sliderError"
		...
		methods: {
			...
			submitForm(formName) {
				this.$refs[formName].validate(async (valid) => {
					if (valid) {
						let src = '';
						console.log( this.form.slider[0]);
